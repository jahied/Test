...
# Decompiled By BD-JAHIED 

# Facebook : https://facebook.com/ROOT.OFF.JAHIED

# uncompyle6 version 

# Original written By BLACK HUNTER TEAM 

import os, sys, time, datetime, random, hashlib, re, threading, json, urllib, cookielib, getpass

__author__ = 'BD-JAHIED'
...
logo = """
TOOLS UPDATE DONE 
/FLOW MY GROUP 👿BLACK HUNTER TEAM👿<::::::::::::::::[]
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[92m  BHT-OK  ' + k + c + user + '  |  ' + pass1
                ...
                print '\x1b[1;91m  BHT-OK ' + k + c + user + '  |  ' + pass1
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[1;92m  BHT-OK ' + k + c + user + '  |  ' + pass2
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;92m  BHT-OK  ' + k + c + user + '  |  ' + pass3
